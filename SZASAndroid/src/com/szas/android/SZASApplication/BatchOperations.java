 ...
 *	Class to handle batch operations execute on DBProvider
 */
public class BatchOperations {
	 ...
	 * @param operation pass ContentProviderOperation
	 */
	...
	public void execute(){
		if(operations.size() == 0)
			return;
		try {
			contentResolver.applyBatch(TAG, operations);//XXX don't know WHAT authority to pass
